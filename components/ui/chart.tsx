...
const ChartTooltip = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
    return (
      <div
        className={cn(
          "pointer-events-none absolute z-50 w-fit rounded-md border bg-popover p-4 text-popover-foreground shadow-sm opacity-0 transition-opacity data-[state=open]:opacity-100",
          className,
        )}
        ref={ref}
        {...props}
